...
def main():
    ...
    print(f"Mean         = {np.mean(samples):.4f}") #print output of numpy mean function, 
    #thousandths
    print()
    ...
    print(f"Mode         = {sorted(statistics.multimode(samples))}") #output of mode function
    # that isn't numpy
    print()

    v = pop_variance(samples)
    print(f"Pop Variance = {v:.4f}") #print output of variance function that was written
